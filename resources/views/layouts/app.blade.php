        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
                <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item"><a class="nav-link" href="#funkciok">Functions</a></li>
                    <li class="nav-item"><a class="nav-link" href="#letoltes">Download</a></li>
                    <li class="nav-item"><a class="nav-link" href="#velemenyek">Reviews</a></li>
